...
class FtpClientController implements Countable
{
    ...
    {
        if (empty($host)) {
            $host = ModuleConfig::getModuleSetting('FtpIp');
        }

        if (empty($port)) {
            $port = ModuleConfig::getModuleSetting('FtpPort');;
        }
    ...
    {
        if (empty($username)) {
            $username = ModuleConfig::getModuleSetting('FtpLogin');
        }

        if (empty($password)) {
            $password = ModuleConfig::getModuleSetting('FtpPassword');
        }
